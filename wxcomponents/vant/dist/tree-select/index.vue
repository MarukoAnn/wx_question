<template>
<uni-shadow-root class="vant-dist-tree-select-index"><view class="van-tree-select" :style="'height: '+(innerHeight)">
  <scroll-view scroll-y class="van-tree-select__nav">
    <van-sidebar @change="onClickNav" custom-class="van-tree-select__nav__inner">
